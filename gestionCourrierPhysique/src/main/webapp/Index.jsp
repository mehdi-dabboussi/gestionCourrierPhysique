...
<spring:url value="/resources/js/bars.js" var="js0" />
<script src="${js0}"></script>
<spring:url value="/resources/js/bootstrap.js" var="js1" />
<script src="${js1}"></script>
<spring:url value="/resources/js/Chart.min.js" var="js2" />
<script src="${js2}"></script>
<spring:url value="/resources/js/chartinator.js" var="js3" />
<script src="${js3}"></script>
<spring:url value="/resources/js/gmaps.js" var="js4" />
<script src="${js4}"></script>
<spring:url value="/resources/js/jquery-2.1.1.min.js" var="js5" />
<script src="${js5}"></script>
<spring:url value="/resources/js/jquery.magnific-popup.js" var="js6" />
<script src="${js6}"></script>
<spring:url value="/resources/js/jquery.nicescroll.js" var="js7" />
<script src="${js7}"></script>
<spring:url value="/resources/js/modernizr.min.js" var="js8" />
<script src="${js8}"></script>
<spring:url value="/resources/js/nivo-lightbox.min.js" var="js9" />
<script src="${js9}"></script>
<spring:url value="/resources/js/scripts.js" var="js10" />
<script src="${js10}"></script>
<spring:url value="/resources/js/skycons.js" var="js11" />
<script src="${js11}"></script>

<spring:url value="/resources/css/bootstrap.css" var="bootstrapCss" />
<link href="${bootstrapCss}" rel="stylesheet" />
<spring:url value="/resources/css/demo-page.css" var="demo-pageCss" />
<link href="${demo-pageCss}" rel="stylesheet" />
<spring:url value="/resources/css/examples.css" var="examplesCss" />
<link href="${examplesCss}" rel="stylesheet" />
<spring:url value="/resources/css/font-awesome.css"
	var="font-awesomeCss" />
<link href="${font-awesomeCss}" rel="stylesheet" />
<spring:url value="/resources/css/geochart.css" var="geochartCss" />
<link href="${geochartCss}" rel="stylesheet" />
<spring:url value="/resources/css/hover.css" var="hoverCss" />
<link href="${hoverCss}" rel="stylesheet" />
<spring:url value="/resources/css/magnific-popup.css"
	var="magnific-popupCss" />
<link href="${magnific-popupCss}" rel="stylesheet" />
<spring:url value="/resources/css/style.css" var="styleCss" />
<link href="${styleCss}" rel="stylesheet" />

<spring:url value="//cdn.jsdelivr.net/modernizr/2.8.3/modernizr.min.js"
	var="js12" />
							...
							<ul class="nofitications-dropdown">
								<li class="dropdown head-dpdn"><a href="#"
									...
									<ul class="dropdown-menu">
										...
										<li><a href="#">
												<div class="user_img">
													<spring:url value="/resources/images/p4.png" var="banner4" />
													<img src="${banner4}" alt="">
										...
										<li class="odd"><a href="#">
												<div class="user_img">
													<spring:url value="/resources/images/p2.png" var="banner2" />
													<img src="${banner2}" alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
										...
										<li><a href="#">
												<div class="user_img">
													<spring:url value="/resources/images/p3.png" var="banner3" />
													<img src="${banner3}" alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
								...
								<li class="dropdown head-dpdn"><a href="#"
									...
									<ul class="dropdown-menu">
										...
										<li><a href="#">
												<div class="user_img">
													<spring:url value="/resources/images/p5.png" var="banner5" />
													<img src="${banner5}" alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
										...
										<li class="odd"><a href="#">
												<div class="user_img">
													<spring:url value="/resources/images/p6.png" var="banner6" />
													<img src="${banner6}" alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
										...
										<li><a href="#">
												<div class="user_img">
													<spring:url value="/resources/images/p7.png" var="banner7" />
													<img src="${banner7}" alt="">
												</div>
												<div class="notification_desc">
													<p>Lorem ipsum dolor</p>
								...
								<li class="dropdown profile_details_drop"><a href="#"
									...
									aria-expanded="false">
										<div class="profile_img">
											<span class="prfil-img"> <spring:url
													value="/resources/images/p1.png" var="banner1" /> <img
												src="${banner1}" alt="">
											</span>
											<div class="user-name">
												<p>Malorum</p>
								...
								<section id="charts1" class="charts">
									<div class="wrapper-flex">
										...
										<div class="col geo_main">
											<h3 id="geoChartTitle">World Marketttttttttt</h3>
					...
					<div class="chart-layer-2">
						...
						<div class="col-md-6 chart-layer2-right">
							<div class="prograc-blocks">
								...
								<div class="bar_group">
									<div class="bar_group__bar thin" label="Rating" 
										 show_values="true" tooltip="true" value="343"></div>
									<div class="bar_group__bar thin" label="Quality"
										show_values="true" tooltip="true" value="235"></div>
									<div class="bar_group__bar thin" label="Amount"
										show_values="true" tooltip="true" value="550"></div>
									<div class="bar_group__bar thin" label="Farming"
