										...
										<div class="table-responsive">
											<table class="table table-striped" style="margin-bottom:5px;">
												<tbody>
													<tr>
														<th >Emetteur : </th>
														<td>${createdtransfert.emetteurUnite.nomUniteBancaire}</td>
													</tr>
													<tr>
														<th >Destinataire :</th>
														<td><c:if test="${createdtransfert.destinataireType == 'unite'}">${createdtransfert.destinataireUnite.nomUniteBancaire}</c:if>
														<c:if test="${createdtransfert.destinataireType == 'contact'}">${createdtransfert.destinataireContact.nomContactExterne}</c:if> 
													</td>
													</tr>
													<tr>
														<th >Estimation :</th>
														<td>${createdtransfert.estimation}</td>
													</tr>
													<tr>
														<th >Date de Transfert :</th>
														<td>${createdtransfert.dateTransfert}</td>
													</tr>
												</tbody>
											</table>
										</div>
									...
									<div  style="margin-right: 5%;">
						                <%--  <spring:url value="/admin/{userId}/delete" var="deleteUrl">
						                 ...
						                 <spring:url value= "/bo/transfert-{idTransfert}-edit" var="editUrl">
						                      	<spring:param name="idTransfert" value="${createdTransfert.idTransfert}"/>
						                      	<spring:param name="idCourrier" value="${createdTransfert.courrier.idCourrier}"/>
						                 </spring:url>
