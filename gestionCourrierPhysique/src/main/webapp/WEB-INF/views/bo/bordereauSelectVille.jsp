								         ...
								         <div class="item form-group ">
										     <label for="inputVilleLab"  class="control-label col-md-3 col-sm-3 col-xs-12">Ville<em>*</em></label>	
										      <div class="col-md-6 col-sm-6 col-xs-12">
												<select name="selectVille" class="select2_single ville form-control" id="ville" tabindex="-1" required>
													<option ></option>
...
<!-- 					                        <div > -->
															...
															<spring:url value="/bo/allNature" var="returnUrl">
									                    	</spring:url>
 ...
 <!-- validator -->
    ...
    $(document).ready(function(){
    	$('selectVille').on('change', function(){
    		var selectedVille = document.getElementById("selectVille").value;
    	})
    })
    </script>
