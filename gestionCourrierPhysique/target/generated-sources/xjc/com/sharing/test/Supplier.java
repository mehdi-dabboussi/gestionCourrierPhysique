...
/**
 * <p>Classe Java pour Supplier complex type.
 * 
...
@XmlType(name = "Supplier", namespace = "http://webServiceExample.sharing.com/xsd", propOrder = {
    "age",
    "name"
})
public class Supplier {

    @XmlElementRef(name = "age", namespace = "http://webServiceExample.sharing.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> age;
    @XmlElementRef(name = "name", namespace = "http://webServiceExample.sharing.com/xsd", type = JAXBElement.class, required = false)
